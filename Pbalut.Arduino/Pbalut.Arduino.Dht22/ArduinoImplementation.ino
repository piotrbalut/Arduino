...
#define GET_TEMPERATURE             0x44
#define GET_HUMIDITY                0x45
...
void sysexCallback(byte command, byte argc, byte *argv)
{
  ...
  switch (command) {
    case GET_TEMPERATURE:
      switch (argv[0]) {
        case 2:
          dtostrf(temperature2, 4, 2, temperatureBuffer);
    ...
    break;
        case GET_HUMIDITY:
          switch (argv[0]) {
            case 2:
              dtostrf(humidity2, 4, 2, humidityBuffer);
              humidity += humidityBuffer;
              Firmata.sendString(humidity.c_str());
              break;
            default:
              break;
          }
